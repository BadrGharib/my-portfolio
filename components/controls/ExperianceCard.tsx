 ...
 * @returns 
 */
function ExperianceCard({companyTitle,companyLogo,roleTitle,roleInfo,color,date,companyLink}: CardExperianceInfo) {
  return (
    <div className='flex flex-col w-full rounded-xl h-[100%] shadow shadow-gray-400'>
      <div className={`h-[150px] rounded-t-xl relative flex justify-center items-center`} style={{backgroundColor:color}}>
       <div className='text-white text-2xl font-sans font-bold'>{companyTitle}</div>
